...
// 2. Populate each index of the array with the corresponding banner line using String.join() // 3. Use a for-each loop to iterate through the array and print each line
